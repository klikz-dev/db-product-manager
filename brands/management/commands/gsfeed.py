...
class Command(BaseCommand):
    ...
    def feed(self):
        ...
        csr.execute("""SELECT P.SKU, P.Title AS PName, P.Handle, PI.ImageURL, M.Name as Manufacturer, PV.Price * PV.MinimumQuantity AS Price, T.Name AS Type, 
                      ...
                      AND M.Brand NOT IN ("Fabricut", "Schumacher", "Scalamandre", "P/K Lifestyles", "Clarence House", "Noir", "Studio Zen", "Cyan", "Couture Lamps", "Global Views", "Olympus Minerals", "Kravet Decor", "Robert Allen", "Nature's Decoration", "Duralee")
